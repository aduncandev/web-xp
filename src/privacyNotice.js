...
export const PRIVACY_FULL = [
  ...
  '1. WHAT THIS SITE IS',
  '',
  '   aduncan.dev is a personal site presented as a Windows XP',
  '   desktop. Almost everything in it runs entirely inside your',
  '   browser. This notice explains the one part that does not.',
  '',
  '',
