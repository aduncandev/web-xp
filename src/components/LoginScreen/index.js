...
const LoginScreen = ({ onLogin, userStatus, onInitiateShutdown }) => {
  ...
  const style = `
    ...
    .login-screen-body { height: 100vh; width: 100vw; display: flex; flex-direction: column; font-family: 'Tahoma', 'Source Sans Pro', sans-serif; position: fixed; top: 0; left: 0; z-index: 9998; overflow: hidden; background-color: #00309C; }
    .login-header-bar { min-height: 112px; width: 100%; background-color: #00309C; position: relative; z-index: 1; flex-shrink: 0; }
    .login-header-bar::before { content: ""; width: 100%; height: 7px; position: absolute; bottom: -2px; left: 0; background: linear-gradient(270deg, #00309C -33.4%, #00309C 6.07%, #FFFFFF 49.56%, #00309C 82.59%, #00309C 121.25%); }

    .login-main-content {
      flex-grow: 1; width: 100%;
      background: radial-gradient(19.48% 42.48% at 10% 22.48%, #9CC0E9 0%, #5A7EDC 100%);
      display: grid;
    ...
    .login-main-branding h1 { font-family: 'Source Sans Pro', 'Tahoma', sans-serif; font-weight: 800; font-size: 1.3em; margin: 0; }
    .login-vertical-line {
        width: 2px; height: 70%;
        align-self: center;
        background: linear-gradient(180deg, #5A7EDC 0%,rgba(255, 255, 255, 0.59) 47.4%, #5A7EDC 98.96%);
    }
    ...
    .login-footer-bar::before { content: ""; width: 100%; height: 7px; position: absolute; top: -2px; left: 0; background: linear-gradient(270deg, #00309C -33.4%, #00309C 6.07%, #FF9933 49.56%, #00309C 82.59%, #00309C 121.25%); }
    ...
    .login-footer-btn-container p { color: #fff; margin-left: 8px; font-size: 1.2em; font-family: 'Source Sans Pro', 'Tahoma', sans-serif; font-weight: 600; }
    .login-footer-info { color: #fff; font-family: 'Source Sans Pro', 'Tahoma', sans-serif; font-size: 0.75em; text-align: right; letter-spacing: 0.5px; font-weight: 600; line-height: 1.3; }
