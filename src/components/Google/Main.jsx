...
import googleLogo from 'assets/google/googlelogo_color_272x92dp.png';
import googleMic from 'assets/google/googlemic_color_24dp.png';
  ...
  return (
    <div className={className}>
      ...
      <section className="content">
        <img className="logo" alt="Google" src={googleLogo} />
        <div className="search-bar">
          ...
          />
          <div className="icon">
            <img src={googleMic} alt="microphone" />
          </div>
        </div>
