...
export const CASCADE_WINDOWS = 'CASCADE_WINDOWS';
export const TILE_WINDOWS_HORIZONTALLY = 'TILE_WINDOWS_HORIZONTALLY';
export const TILE_WINDOWS_VERTICALLY = 'TILE_WINDOWS_VERTICALLY';
