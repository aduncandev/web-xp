...
HTMLManager.prototype.gameOverMessage = function (coins, win, manager) {
  ...
  switch (songIndex) {
    case '0':
      winSound = new Audio("./voltorbflipsounds//win.mp3");
      explodeSound = new Audio("./voltorbflipsounds//explode.mp3");
      break;
    case '1':
  ...
  const sfxVol = typeof window.vfSfxVolume === "number" ? window.vfSfxVolume : 1;
  winSound.volume = sfxVol;
  explodeSound.volume = sfxVol;
